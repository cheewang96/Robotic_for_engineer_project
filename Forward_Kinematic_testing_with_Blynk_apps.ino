...
char auth[40] = "BfxiZqXhlXezs7APkSlZw1e8RTbXvY3-";
SoftwareSerial DebugSerial(50, 51); // RX, TX

int x;
int d1; int d2; int d3;
float px; float py; float pz;
int servopin = 4; Servo servo4;


///////////////////////////////// Blynk declaration ///////////////////////////////////
int button1Presses = 0;
boolean button1Pressed = false; boolean button2Pressed = false;
int slider1PosSaves[] = {1,1,1,1,1}; int slider2PosSaves[] = {1,1,1,1,1};
int slider3PosSaves[] = {1,1,1,1,1}; int slider4PosSaves[] = {1,1,1,1,1};
int slider1Pos; int slider2Pos; int slider3Pos; int slider4Pos;
...
double Kp = 0.3; double Ki = 0.1; double Kd = 0.1;
...
//PID tuning based on trial & error
double Kp2 = 0.3; double Ki2 = 0.1; double Kd2 = 0.1;
...
//////////////////////Blynk Code Start//////////////////////
  if(button1Pressed){
    switch(button1Presses){
        case 1:
          slider1PosSaves[0] = slider1Pos;
          slider2PosSaves[0] = slider2Pos;
          slider3PosSaves[0] = slider3Pos;
          slider4PosSaves[0] = slider4Pos;
          terminal.println("Pos 1 saved");
          Serial.println("Pos 1 saved");
          /*Serial.print(servo1PosSaves[0]);
          Serial.print(",");
          Serial.print(servo2PosSaves[0]);
          Serial.print(",");
          Serial.print(servo3PosSaves[0]);
          Serial.println("");*/
          break;
          
        case 2:
           slider1PosSaves[1] = slider1Pos;
           slider2PosSaves[1] = slider2Pos;
           slider3PosSaves[1] = slider3Pos;
           slider4PosSaves[1] = slider4Pos;
           terminal.println("Pos 2 Saved");
           Serial.println("Pos 2 saved");
           break;
           
        case 3:
           slider1PosSaves[2] = slider1Pos;
           slider2PosSaves[2] = slider2Pos;
           slider3PosSaves[2] = slider3Pos;
           slider4PosSaves[2] = slider4Pos;
           terminal.println("Pos 3 Saved");
           Serial.println("Pos 3 saved");
           break;
           
         case 4:
           slider1PosSaves[3] = slider1Pos;
           slider2PosSaves[3] = slider2Pos;
           slider3PosSaves[3] = slider3Pos;
           slider4PosSaves[3] = slider4Pos;
           terminal.println("Pos 4 Saved");
           Serial.println("Pos 4 saved");
           break;
           
         case 5:
           slider1PosSaves[4] = slider1Pos;
           slider2PosSaves[4] = slider2Pos;
           slider3PosSaves[4] = slider3Pos;
           slider4PosSaves[4] = slider4Pos;
           terminal.println("Pos 5 Saved");
  ...
  if(button2Pressed){
    for(int i = 0; i < 5; i++){
        ...
        anglex = slider1PosSaves[i];
        angley = slider2PosSaves[i];
        anglez = slider3PosSaves[i];
        servo4.write(slider4PosSaves[i]);
        
        terminal.print(" Angles: "); terminal.println(i + 1);
        terminal.println(slider1PosSaves[i]);
        terminal.println(slider2PosSaves[i]);
        terminal.println(slider3PosSaves[i]);
        terminal.println(slider4PosSaves[i]);
        Serial.println("Running");
        Serial.print(slider1PosSaves[i]);
        Serial.print(",");
        Serial.print(slider2PosSaves[i]);
        Serial.print(",");
        Serial.print(slider3PosSaves[i]);
        Serial.print("");
      }
      terminal.flush();
  }
...
////////////////////////// Blynk Virtual Pins Declaration /////////////////////////

//xangle
BLYNK_WRITE(V1){slider1Pos = (param.asInt());}

//yangle
BLYNK_WRITE(V2) {slider2Pos = (param.asInt());}

//zangle
BLYNK_WRITE(V3) {slider3Pos = (param.asInt());}

//servo4
BLYNK_WRITE(V8) {slider4Pos = (param.asInt());}

//Record
BLYNK_WRITE(V4)
{
  if(param.asInt() == 1){button1Presses++; button1Pressed = true;}
  else {button1Pressed = false;}
}

//Play
BLYNK_WRITE(V5){button2Pressed = true;}

//Reset
BLYNK_WRITE(V6)
{ 
  button1Presses = 0; button2Pressed = false;
  for(int i = 0; i < 5; i++)
  {
    slider1PosSaves[i] = 0; slider2PosSaves[i] = 0;
    slider3PosSaves[i] = 0; slider4PosSaves[i] = 0;
  }
  terminal.println("Everything reseted");
  Serial.println("Everything reseted");
}

////////////////////////////// Blynk Virtual Pins End //////////////////////////////
